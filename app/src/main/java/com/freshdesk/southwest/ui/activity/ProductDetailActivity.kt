...
import com.freshdesk.southwest.ui.activity.ProductDetailActivity.ScreenState.ProductDetail
            ...
            Row(
                ...
                Image(
                    ...
                    modifier = Modifier
                        .padding(16.dp)
                        .clickable {
                            FreshdeskSDK.openKnowledgeBase(this@ProductDetailActivity)
                        },
                    contentDescription = stringResource(id = R.string.show_knowledge_base)
                )
